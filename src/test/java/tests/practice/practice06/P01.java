...
public class P01 {
    ...
    public void test01() {
        ...
        /*
            Yukarıdaki gibi her defasında actions ile her defasında driver'ı çağırmak
        yerine aşağıdaki gibi bir kere driver'ı çağırıp en sonda da bir kez perform() dememiz
        daha clean, daha uygundur...
        */
